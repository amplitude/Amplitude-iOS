...
3. Copy the Amplitude-iOS folder into the source of your project in XCode. Check "Copy items into destination group's folder (if needed)".  The iOS version will compile and work on MacOSX as well.
